...
class RefundTest extends TestCase
{
    ...
    public function testRefundByHash()
    {
        ...
        $result = $refund->requestByHash('59386e0a5f258ffed3bee6fecc9150f916d1e19aa50ec68c', 10.23, 'description', 'optional_merchant_payment_code');
    ...
    {
        $refund = new RefundForTests($this->config, $this->client);
        $result = $refund->requestByMerchantPaymentCode('59386e0a5f258ffed3bee6fecc9150f916d1e19aa50ec68c', 10.23, 'description', 'optional_merchant_payment_code');
