...
class RapipagoTest extends GatewayTestCase
{
    ...
    public function testSandboxTicketUrl()
    {
        ...
        $this->assertEquals(
            'https://staging.ebanx.com.br/print/voucher/?hash=59dd440f947b5097c8f6985c6a5cb71f935d80f745f37d5e',
    ...
    public function testLiveTicketUrl()
    {
        $gateway = $this->getTestGateway();
        $this->assertEquals(
            'https://print.ebanx.com.br/print/voucher/?hash=59dd440f947b5097c8f6985c6a5cb71f935d80f745f37d5e',
