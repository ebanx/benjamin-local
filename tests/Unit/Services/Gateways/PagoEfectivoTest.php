...
class PagoEfectivoTest extends GatewayTestCase
{
    ...
    public function testSandboxTicketUrl()
    {
        ...
        $this->assertEquals(
            'https://staging.ebanx.com.br/cip/?hash=59260f14654c5e69344fec4cd0e22fe1d9177a5898e3a3d3',
    ...
    public function testLiveTicketUrl()
    {
        $gateway = $this->getTestGateway();
        $this->assertEquals(
            'https://print.ebanx.com.br/cip/?hash=59260f14654c5e69344fec4cd0e22fe1d9177a5898e3a3d3',
