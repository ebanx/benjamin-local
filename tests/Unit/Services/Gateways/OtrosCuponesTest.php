...
class OtrosCuponesTest extends GatewayTestCase
{
    ...
    public function testSandboxTicketUrl()
    {
        ...
        $this->assertEquals(
            'https://staging.ebanx.com.br/print/voucher/?hash=59dd49e565e80d37b1995a9dfa2767e2494060237b13c3b8',
    ...
    public function testLiveTicketUrl()
    {
        $gateway = $this->getTestGateway();
        $this->assertEquals(
            'https://print.ebanx.com.br/print/voucher/?hash=59dd49e565e80d37b1995a9dfa2767e2494060237b13c3b8',
