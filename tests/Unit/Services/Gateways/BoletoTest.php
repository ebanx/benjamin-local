...
class BoletoTest extends GatewayTestCase
{
    ...
    public function testSandboxTicketUrl()
    {
        ...
        $this->assertEquals(
            'https://staging.ebanx.com.br/print/?hash=591b803da5549b6a1bac524b31e6eef55c2e67af8e40e1e4',
    ...
    public function testLiveTicketUrl()
    {
        $gateway = $this->getTestGateway();
        $this->assertEquals(
            'https://print.ebanx.com.br/print/?hash=591b803da5549b6a1bac524b31e6eef55c2e67af8e40e1e4',
