...
class OxxoTest extends GatewayTestCase
{
    ...
    public function testSandboxTicketUrl()
    {
        ...
        $this->assertEquals(
            'https://staging.ebanx.com.br/print/oxxo/?hash=5924c698895ed4cf3764c681fe9496f8fe0a986b070a594e',
    ...
    public function testLiveTicketUrl()
    {
        $gateway = $this->getTestGateway();
        $this->assertEquals(
            'https://print.ebanx.com.br/print/oxxo/?hash=5924c698895ed4cf3764c681fe9496f8fe0a986b070a594e',
