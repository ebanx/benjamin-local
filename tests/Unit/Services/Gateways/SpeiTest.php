...
class SpeiTest extends GatewayTestCase
{
    ...
    public function testSandboxTicketUrl()
    {
        ...
        $this->assertEquals(
            'https://staging.ebanx.com.br/print/spei/execute?hash=5a53bc54679dbc1f3baf868e9d5d257ee7367fd5c47983fc',
    ...
    public function testLiveTicketUrl()
    {
        $gateway = $this->getTestGateway();
        $this->assertEquals(
            'https://print.ebanx.com.br/print/spei/execute?hash=5a53bc54679dbc1f3baf868e9d5d257ee7367fd5c47983fc',
